...
$id = $_GET['idSitio'];
$view = "SELECT * from sitios where md5(idSitio) = '$idSitio'";
...
if(isset($_POST['update'])){
	...
	$insert = "UPDATE sitios set categoria_id = '$categoria_id', nombre = '$nombre', quantity = '$quantity', purchase = '$purchase', retail = '$retail', descripcion = '$descripcion' where md5(idSitio) = '$ID'";
...
?>
    ...
    <td><input type="text" id="txtbox" name="name" placeholder="Nombre" value="<?php echo $row['nombre'];?>" required><br></td>
    </tr>
