				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
					<div class="thumbnail">
						...
						<div class="caption">
							...
							<p>
								<a href="sales1.php" class="btn btn-primary btn-block" id="verPaquetes">Reservar</a>
								<div class="btn-group btn-group-justified">
									<a href="formSitio2.php?id=<?=$sitio->getId()?>" class="btn btn-default" id="modificar">Modificar</a>
									<a href="eliminarSitio2.php?id=<?=$sitio->getId()?>" class="btn btn-warning" id="eliminar">Eliminar</a>
								</div>
