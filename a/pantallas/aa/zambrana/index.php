		...
		<section class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
				<div class="thumbnail">
					...
					<img src="img/11.jpg" width="336" height="173">
					<div class="caption">
						<h3>Limpieza</h3>
						<p>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
					<div class="thumbnail">
						...
						<div class="caption">
							<p>
								<a href="index1.php" class="btn btn-primary btn-block" id="verPaquetes">Jinetes</a>
								<div class="btn-group btn-group-justified">
									<a href="index2.php?id=<?=$sitio->getId()?>" class="btn btn-default" id="modificar">Caballos</a>
									<a href="index3.php?id=<?=$sitio->getId()?>" class="btn btn-warning" id="eliminar">Limpieza</a>
								</div>
