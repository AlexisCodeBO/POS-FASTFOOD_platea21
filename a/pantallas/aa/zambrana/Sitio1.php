...
<tr>
	...
	<table width="669" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <th width="80" scope="col"><a href="sitios1.php">Productos</a></th>
...
<table width="83%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <form action="result_sitios1.php" method="get" ecntype="multipart/data-form">
...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr align="center" style="height:25px">
        ...
        <td style="border-bottom:1px solid #333;">$ <?php echo $row['foto']; ?> </td>
