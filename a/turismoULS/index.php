		...
		<div class="container">
			...
			<div id="carousel-turismo" class="carousel slide" data-ride="carousel">
							<ol class="carousel-indicators">
								<li data-target="#carousel-turismo" data-slide-to="0" class=""></li>
								<li data-target="#carousel-turismo" data-slide-to="1" class=""></li>
								<li data-target="#carousel-turismo" data-slide-to="2" class="active"></li>
							</ol>
							<div class="carousel-inner">
								...
								<div class="item active">
									<img data-src="holder.js/900x500/auto/#555:#5a5a5a/text:Third slide" alt="Third slide" src="">
									<div class="container">
										<div class="carousel-caption">
