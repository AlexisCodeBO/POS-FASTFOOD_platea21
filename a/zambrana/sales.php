...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr align="center" style="height:35px">
        ...
        <a href="process_sales.php?id=<?php echo $row['idSitio'];?>"><input type="button" value="Pedir" style="width:90px; height:30px; color:#FFF; background: #930; border:1px solid #930; border-radius:3px;"></a>
...
<tr>
	<td>
    &copy; 2017 Boutique   |  Marianne:<a href="https://www.facebook.com/platea21">Platea21</a>	
    </td>
</tr>
</table>
</div>
