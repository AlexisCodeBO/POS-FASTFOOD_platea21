...
<tr>
	...
	<table width="669" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    ...
	    <th width="112" scope="col"><a href="salesreport.php">Reporte</a></th>
	    </tr>
	  </table>
      </td>
...
$id = $_GET['id'];
$view = "SELECT * from sitios where idSitio = '$id'";
$result = $db_link_equitacion->query($view);
...
$view1 = "SELECT quantity from sitios where idSitio = '$id'";
$result1 = $db_link_equitacion->query($view);
$row2 = $result->fetch_assoc();
	...
	$insert1 = "UPDATE products set quantity = quantity - '$quant' where idSitio = '$ID'";
	...
	if($db_link_equitacion->query($insert1)== TRUE){
...
?>
    ...
    <td><input type="text" id="txtbox" name="categoria_id" value="<?php echo $row['categoria_id'];?>" readonly><br></td>
    </tr>
    
    <tr>
    <td align="right">Nombre Producto:</td>
    <td><input type="text" id="txtbox" name="nombre" value="<?php echo $row['nombre'];?>" readonly><br></td>
    </tr>
