...
<tr>
    ...
    <table width="41%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td width="80%" align="left"> <font size="12px">R</font><span style="font-size: 18px;">ervas<b></b><b></b</span></td>
	    </tr>
	  </table></td>
...
<tr>
	<td>
    &copy; 2017 marianne  |  Designed By:<a href="https://www.facebook.com/tienda marianne">tienda marianne</a>	
    </td>
</tr>
</table>
</div>
...
<div id="popup-container2">
    ...
    <br>
    <p style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:16px;" background:#FF0000> Formulario de Reserva </p>
    </div>
...
?>
    ...
    <td>
    <br>
    <input type="SUBMIT" name="update" id="btnnav" value="Reservar"></form>
    <a href="sales1.php"><input type="button" style="border:1px solid #900; background:#900; height:40px; width:105px; border-radius:3px; color:#FFF;" value="Cancelar"></a>
...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr align="center" style="height:35px">
        ...
        <a href="process_sales1.php?id=<?php echo md5($row['id']);?>"><input type="button" value="Reservar" style="width:90px; height:30px; color:#000000; background: #00FF00; border:1px solid #930; border-radius:3px;"></a>
