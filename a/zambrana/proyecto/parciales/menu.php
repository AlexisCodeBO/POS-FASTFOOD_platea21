<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
						<span class="sr-only">AdheMau</span>
			...
			<button type="submit" class="btn btn-primary" id="btn">Guardar</button>
									...
									<div class="modal-footer" id="asd">
										<button type="button" class="btn btn-default" data-dismiss="modal" id="btn">Cerrar</button>										
									</div>
								</div>
							</div>
						</div>
						...
						<li class="dropdown">
							...
							<a data-toggle="modal" href='#modal-id'>Login</a>
								<div class="modal fade" id="modal-id">
									<div class="modal-dialog">
										<div class="modal-content" id="wer">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
												<h4 class="modal-title">Cuenta</h4>
											</div>
											<div class="modal-body">
												<form action="validar.php" method="POST" role="form" id="losa">
													...
													<button type="submit" class="btn btn-primary" id="btn">Iniciar secion</button>
												</form>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-default" data-dismiss="modal" id="btn">Cerrar</button>
												<button type="button" class="btn btn-primary" id="btn">Guardar cambios</button>
											</div>
										</div>
									</div>
								</div>	
