...
<?php include('parciales/foot_cabecera.php') ?>	
		...
		?>
		<div class="container">
		<form action="" method="POST" role="form" id="fsitio" id="mane" >
			<?php if ($sw) { ?>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="nombre" name="nombre" value="<?=$sw?$arr[0]->getNombre():''?>" placeholder="Nombre de producto">
			</div>
			<div class="form-group">
