...
<tr>
    ...
    <table width="41%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td width="80%" align="left"> <font size="12px">B</font><span style="font-size: 18px;">utique <b>M</b>arianne </span></td>
	    </tr>
	  </table></td>
...
<header class="row">
	...
	<table width="124" border="0" align="left" cellpadding="0" cellspacing="0">
	  <tr>
	    <th width="btn btn-primary" scope="col"><a href="sales1.php">Reservas</a></th>

      
      <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
        <div class="btn-group pull-right">
          <a class="btn btn-primary " href="a/index.html" role="button">INICIO</a>
          <a class="btn btn-primary" href="a/zambrana/index.php" role="button">PRODUCTOS</a>
          <a class="btn btn-primary " href="a/catalogo.html" role="button">CATALOGO</a>
          <a class="btn btn-primary" href="http://maps.google.com/maps/ms?ie=UTF8&hl=en&msa=0&ll=-16.524563,-68.089802&spn=0.002391,0.004823&t=h&z=18&msid=111673698215909396640.000482bcf9f11d4559859" role="button">UBICACION</a>
          <a class="btn btn-primary " href="a/Distribuidores.html" role="button">DISTRIBUIDORES</a>
          <a class="btn btn-primary" href="https://www.facebook.com/pg/boutique.marianne/about/?ref=page_internal" role="button">CONTACTOS</a>
        </div>
      </div>  
    </header>
	    </tr>
...
<tr>
	<td>
    &copy; 2017 Butique |  Marianne:<a href="https://www.facebook.com">marianne</a>	
    </td>
</tr>
</table>
</div>
