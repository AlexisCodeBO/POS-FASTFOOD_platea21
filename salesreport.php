...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="80%">
      ...
      <form action="salesreport.php" method="get" ecntype="multipart/data-form">
        <td width="48%" height="37" align="right"><input type="text" name="d1" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="2017-12-12" required /></td>
        <td width="15%" align="left"> <input type="text" name="d2" style="border:1px solid #CCC; color: #333; width:210px; height:30px;" placeholder="2017-12-12" required  /> </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#033;">
     ...
     <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #030; background: #030; color:#FFF;"> Resumen de Ventas </th>
      ...
      <tr height="30px">
        ...
        <th style="border-bottom:1px solid #333;"> Producto Reservado </th>
        <th style="border-bottom:1px solid #333;"> Cantidad deservada </th>
        <th style="border-bottom:1px solid #333;"> Monto a Pagar </th>
