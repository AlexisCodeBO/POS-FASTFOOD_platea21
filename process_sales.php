...
?>
<body style=" background:url('cap/fondoo.jpg') no-repeat center fixed;  -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
...
<tr>
    ...
    <table width="41%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <th scope="col"><font size="12px">B</font><span style="font-size: 18px;">utique </span></th>
	    </tr>
	  </table></td>
...
<tr>
	<td>
    &copy; 2017 boutique  |  marianne:<a href="https://www.facebook.com">marianne</a>	
    </td>
</tr>
</table>
</div>
...
?>
    ...
    <tr>
    <td align="right" style="font-color: #000000"> Fecha Actual: </td>
    ...
    <tr>
    <td align="right" style="color:#ff0000 ">Categoria:</td>
    <td><input type="text" id="txtbox" name="category" value="<?php echo $row['category'];?>" readonly><br></td>
    </tr>
    
    <tr>
    <td align="right" style="color:#ff0000 ">Nombre Producto:</td>
    ...
    <tr>
    <td align="right" style="color:#ff0000 ">total</td>
