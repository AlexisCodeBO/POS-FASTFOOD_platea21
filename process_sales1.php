...
?>
 <body style=" background:url(img/23.jpg) no-repeat center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
...
<tr>
	<td>
     &copy; 2017 boutique |  Designed By:<a href="https://www.facebook.com">marianne</a>	
    </td>
</tr>
</table>
</div>
...
?>
    ...
    <tr>
    <td align="right">Precio de adquicicion:</td>
...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr align="center" style="height:35px">
        ...
        <a href="process_sales1.php?id=<?php echo md5($row['id']);?>"><input type="button" value="pedirs" style="width:90px; height:30px; color:#FFF; background: #930; border:1px solid #930; border-radius:3px;"></a>
